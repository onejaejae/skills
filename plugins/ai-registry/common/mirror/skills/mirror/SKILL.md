...
name: mirror
description: |
  "/mirror", "mirror back", "echo back", "이해한 거 맞아?",
  "내가 뭘 원하는지 말해봐", "확인해줘", "paraphrase this",
  "너가 이해한 거 설명해봐", "what did I ask?"
allowed-tools:
  - AskUserQuestion
  - Read
  - Grep
  - Glob
validate_prompt: |
  Must contain Mirror Back with What/Why/Scope/Constraints AND Gaps & Assumptions.
...
- **/quick-plan** → `"Run: /quick-plan \"[1-line What summary]\""` → Stop
...
- [ ] At least 1 MIRROR presented with all 5 sections (What/Why/Scope/Constraints/Gaps & Assumptions), OR fast-path confirmation used for already-clear input
