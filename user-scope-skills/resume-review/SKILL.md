...
3. **Before/After 완전 포함**: 🔴 즉시 수정 항목 **모두**에 Before/After 예시를 포함한다. 하나라도 빠지면 안 된다. 각 PARIS 진단에도 Before/After를 포함한다. Before는 이력서 원문을 정확히 인용하고, After는 멘티가 바로 참고할 수 있는 구체적 수준으로 작성한다.
